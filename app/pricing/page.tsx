...
export default function PricingPage() {
  ...
  const [activeTab, setActiveTab] = useState<'clients' | 'lawyers'>('clients')
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-32 md:pt-36 pb-8 bg-gradient-to-r from-blue-600 to-indigo-600 relative overflow-hidden">
      ...
      {/* Compact Toggle */}
      <section className="bg-white border-b border-gray-200 py-3 shadow-sm">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex bg-gray-100 rounded-full p-1">
                ...
                >
                  Yearly
                  <span className="ml-1 text-[10px] bg-green-500 text-white px-1.5 py-0.5 rounded-full">
                    -20%
                  </span>
                </button>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-sm">
                Every plan lowers the fee we take on your invoices.
              </p>
            </div>
              ...
              {lawyerPlans.map((plan) => (
                ...
                >
                  ...
                  <div className="text-center mb-4">
                    <div className={`w-14 h-14 bg-gradient-to-r ${plan.color} rounded-full flex items-center justify-center text-xl mx-auto mb-3 shadow-lg`}>
                      {plan.icon}
                    </div>
                  ...
                  <div className="text-center mb-5">
                    <p className="text-[10px] text-gray-500 uppercase font-semibold">Platform fee</p>
                    <p className="text-xl font-bold text-blue-600">{plan.platformFee}</p>
                    <p className="text-[10px] text-gray-500">on each invoice</p>
                  </div>
            ...
            <div className="max-w-md mx-auto mt-8">
              {promoApplied ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                  <p className="text-green-700 font-semibold text-sm">✓ Promo code applied successfully!</p>
                </div>
              ) : (
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  />
                  <button
            ...
            {/* Value Comparison */}
            <div className="max-w-2xl mx-auto mt-8 bg-gray-50 rounded-xl p-6">
              <p className="text-sm font-bold text-gray-900 mb-3 text-center">Does it pay off? On ₦500,000/month</p>
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white rounded-lg p-3 text-center">
                  <p className="text-[10px] font-semibold text-gray-700">Free — 12%</p>
                  <p className="text-lg font-bold text-gray-900">₦60k</p>
                </div>
                <div className="bg-white rounded-lg p-3 text-center border-2 border-blue-600">
                  <p className="text-[10px] font-semibold text-blue-600">Pro — 7%</p>
                  <p className="text-lg font-bold text-blue-600">₦40k</p>
                </div>
                <div className="bg-green-50 rounded-lg p-3 text-center border-2 border-green-500">
                  <p className="text-[10px] font-semibold text-green-700">You keep</p>
                  <p className="text-lg font-bold text-green-700">₦20k+</p>
                </div>
              </div>
              <p className="text-[10px] text-gray-500 text-center mt-3">
                Billed monthly in naira through Paystack. Cancel any time.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="py-10 bg-gray-50 border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl md:text-2xl font-bold text-center mb-6">Compare Features</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="text-center py-3 px-4 font-semibold bg-blue-50">Lawyer Pro</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Browse Lawyers Directory</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Read Articles & Journals</td>
                  <td className="text-center text-gray-400">Limited</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Access Training Courses</td>
                  <td className="text-center text-gray-400">Preview</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Document Templates</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Featured Lawyer Listing</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Case Management Tools</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Escrow Protection</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-green-600">✓</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-2.5 px-4">Analytics Dashboard</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-red-400">—</td>
                  <td className="text-center text-green-600 bg-blue-50">✓</td>
                </tr>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: 'Client funds are held securely for 7 days after work is completed.'
              },
              {
                q: 'Are lawyers on the platform verified?',
                a: 'Yes, every lawyer is checked against their NBA branch and credentials.'
              },
              {
                q: 'What is the platform fee?',
                a: 'A percentage charged on each invoice. It decreases as you upgrade.'
              },
            ].map((faq, index) => (
              <div 
                key={index} 
